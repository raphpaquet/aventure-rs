...
export default function RiviereDumoine(props) {


  const positionDumoine = {
    lat: 46.015310, 
    lng: -76.767663
  }
  const name = "Dumoine"
  ...
  let content = {
    English: {
      ...
      description: "The Dumoine river is located in the municipality of Pontiac, Outaouais. This river is very popular with canoeists.",
      riverDescription: ""
    },
    French: {
      seoTitle: "Riviere Orange Outaouais",
      description: "La Rivière Dumoine est située dans la municipalité de Pontiac, Outaouais. Cette rivière est très prisée par les amateurs de canot",
      riverDescription: ""
    }
  }
  ...
  return (
    <div className="riviere">
      ...
      <h1 className="title">La Rivière Dumoine</h1>
